...
export default class DependentDropdown extends Component {
    ...
    loadOptions(url) {
        if (url.trim() !== "") {
            if (this.props.parentObjData.value)
                ...
                return new Promise((resolve, reject) => resolve()).then(() => { options: [] });
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        if (this.props.parentObjData.value === undefined && nextProps.parentObjData.value === undefined) {
        ...
        else if (this.props.parentObjData.value === undefined && nextProps.parentObjData.value.value)
        {
        ...
        else if (this.props.parentObjData.value === null ||
            this.props.parentObjData.value.value !== nextProps.parentObjData.value.value) {
