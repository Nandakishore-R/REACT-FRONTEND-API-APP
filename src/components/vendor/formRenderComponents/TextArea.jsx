...
export default class TextArea extends Component {
    ...
    renderTextArea() {
        return (
          <textarea
            ...
            onChange={(evt) => this.props.handleInput(evt.target.value, this.props.index)}
    ...
    renderTyniMce() {
        return (
          <formRendererDeps.TinyMce.Editor
            ...
            onChange={(e) => this.props.handleInput(e.target.getContent(), this.props.index)}
          />
        );
    }
    ...
    render() {
        ...
        return (<div className={"form-group " + (this.props.hidden ? 'hidden' : 'shown')} id={this.props.name + 'Div'} style={this.props.controlStyle}>
            ...
            {content}
            <div className="printTextArea" style={{ display: 'none'}}>{this.props.value}</div>
            </div>);
       //}
    }
