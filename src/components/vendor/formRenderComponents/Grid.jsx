...
export default class Grid extends Component {
    ...
    componentDidMount() {
      ...
      $('.datepicker', this.elRef.current).datetimepicker({
        format: 'L',
    ...
    renderCellContent = cell => {
      ...
      const props = {
          className: "form-control".concat(cell.type === 'date' ? ' datepicker' : ''),
          'cell-key': cell.key,
          value: cell.value,
          type: cell.type === 'bool' ? 'checkbox' : (cell.type === 'date' ? 'text' : cell.type),
          ...(cell.type === 'bool' && cell.value === true ? { checked: 'checked' } : { checked: '' } ),
          ...(cell.type !== 'date' ? { onChange: onChangeLocal } : { value: undefined, defaultValue: cell.value }),
      ...
      return cell.isHeader
          ? cell.value
          : (cell.type === 'bool' ? <div className="checkbox"><label><input {...props} /></label></div> : <input {...props} title={props.value} />)
    };
