...
export default class Section extends Component {
    ...
    generateSection() {
        return this.props.formRender.generateLayout(this.props, this.props.formRender);
    }
    getHeader(show) {
        if (show) {
    ...
    render() {
        ...
        // console.log('Section - KEY:',this.props.name);
        return <div className={layoutSectionClass} key={this.props.name} id={this.props.name + 'Div'} style={this.props.controlStyle}>            
