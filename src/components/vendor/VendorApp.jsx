...
//   const activeTab = useSelector((state) => state.vendor.activeTab);
...
//   const isCentrilizedUser = false;
//   const useCheckHasCentrilizedAccess = () => {
//     const setBooleanForCentrilizedUser = isCentrilizedUser === "false" ? false : true; // isCentrilizedUser returns true and false as string
...
//   //                 var dataNew = { ...detailsData, Type: vendorType, InActivationEvidence: "", FormData: formJSon };
...
//   //     "VendorDetails": <VendorDetailsForm  />,
//   //     "VendorCategorizationScoring": <VendorCategorization />,
//   //     "VendorAdditionlaDetails": <AdditionalDetails />,
...
//   //         let nextTab = activeTab === "VendorDetails" ? "VendorCategorizationScoring" : activeTab === "VendorCategorizationScoring" ? "VendorAdditionlaDetails" : activeTab === "VendorAdditionlaDetails" ? "VendorRating" : "reviewId"
//   //         if (isInViewMode || (activeTab === "VendorCategorizationScoring" && vendorType == "DSA")) {
//   //             let tab = tabData.find(tab => tab.id == nextTab)
//   //             let title = tab ? tab.title : "";
//   //             saveTabChange(nextTab, title);
//   //         }
//   //         else
//   //             handleSaveBtnClick(nextTab);

//   //     } else {

//   //         let prevTab = activeTab === "reviewId" ? "VendorRating" : activeTab === "VendorRating" ? "VendorAdditionlaDetails" : activeTab === "VendorAdditionlaDetails" ? "VendorCategorizationScoring" : "VendorDetails"
//   //         if (isInViewMode || (activeTab === "VendorCategorizationScoring" && vendorType == "DSA")) {
